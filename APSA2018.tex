...
\begin{table}[!htbp] \centering 
  \caption{Responses to FOIA Census for Congressional Contacts as of Aug. 2018} 
  \label{responserates} 
\begin{tabular}{@{\extracolsep{5pt}} cccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
Department & Components & Provided Records & Coded \\ 
\hline \\[-1.8ex] 
