...
We tackle these classic empirical questions of constituency service with a new approach---by looking at when legislators contact government agencies on behalf of their constituents.  Recent work using this type of congressional correspondence data has yielded important findings regarding the policy strategies of cross-pressured legislators \citep{Ritchie2017}, distributive politics \citep{MillsKalafHuges2015}, descriptive representation \citep{LowandeRitchieLauterbach2018}, and the role of ideology in congressional oversight \citep{Lowande2018JOP}.  We build on the work of   \citet{MillsKalafHuges2015}, \citet{Ritchie2017},, \citet{LowandeRitchieLauterbach2018}, and \citet{Lowande2018JOP} in this paper to tackle these long-standing questions of constituency service.  
...
\scalebox{0.6}{\includegraphics{data_by_type.pdf}}
\end{figure}


\subsubsection{Unequally distributed advocacy}

The number of constituency service requests that legislators write is distributed highly unequally across and within the House and Senate---evidence that this is behavior that some legislators specialize in, while other legislators engage in only sparingly. Indeed, Senate and House Gini coefficients are comparable to income inequality in the US and Mexico---in short, there is considerable across-legislator variation in how elected officials contact agencies, whether on behalf of constituents or policy. And the same legislators tend engage in disproportionately more or less constituent service and policy work. We consider some potential explanations for this variation, before highlighting the role of a legislator's power in Washington.  
