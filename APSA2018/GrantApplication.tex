...
The results of our pilot study suggest that this data collection project has the potential to shed new light on a previously unstudied form of congressional representation.  While congressional scholars have written frequently on forms of congressional representation in general and constituency service in particular, a mere handful of these analyses are based on actual constituency service data.  This omission in the literature is for a good-reason. Up to this point, scholars have lacked data on actual constituency service.  A few recent studies do employ constituency service data, but focus on a small number of agencies severely limiting what can be learned about constituency service and representation.  Our project avoids these limitations by turning to the federal agencies themselves, and asking them to tell us what contact they receive from members of Congress. We plan to use the data we collect to provide insights in three fields: 1) inequalities in representation, 2) money in politics and 3) legislative behavior. 
...
Third, our expansive data set on constituency service requests can provide insights into legislator behavior.  There have been long-standing public concerns that incumbent legislators ``go Washington'' and neglect their constituents over time. This data allows us to explicitly examine that claim, and results from our pilot study suggest the opposite -- as legislators gain influence in Washington they increase their advocacy on behalf of their constituents. 
...
\singlespace
\begin{itemize}
	\item[-] December, 2019: Complete coding of FOIA requests
	\item[-] February-March, 2020: Visit DC to interview elected officials
	\item[-] April, 2020: Present draft of paper on who contacts bureaucracy
	\item[-] September, 2020: Present paper on how Congressional rule changes affects contact of bureaucracy
	\item[-] December, 2021: Complete coding of donor activity
	\item[-] April, 2021: Present draft of paper on ``Donor Advocacy''
	\item[-] May, 2021: Publish database including FOIA contact information. 
\end{itemize}
