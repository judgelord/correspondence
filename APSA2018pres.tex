...
% Hi, My name is Devin Judge-Lord and I am presenting work with coauthors Justin Grimmer and Ellie Powell based on a very large new database of requests sent from individual members of Congress directly a federal agencies. We have spent the past 2 years collecting and coding these data, and I am excited to share our very first findings from this project. 

% We started with a common intuition that Members of Congress have limited time and attention to divide among, for example, constituent work and policy work. We have come to question the value of this intuition for explaining legislator behavior. 
% We did not find a tradeoff between attentive and influential; instead, some legislators are both and some are neither. 
...
% this intuition emerges from scholarship. Fenno called it Potomac Feaver--the idea that the deeper a legislator gets into Washington policymaking, the less time they had for their district constituents--thus competing goals of good policy and influence in washington and reelectoin.
...
%This has been true since legislators helped constituents get pensions after the revolutionary war and especially with the rise of the administrative state. Federal agencies shape nearly every aspect of our lives: 
...
% from, at the worst, handwritten logs with nothing but obscure acronyms to indicate the topic, as in this log from ICE
\begin{frame}
\frametitle{Correspondence Data}
...
150,000+ legislator requests (and counting) for 2007-2018
