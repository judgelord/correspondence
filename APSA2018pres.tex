...
% I am presenting work with coauthors Justin Grimmer and Ellie Powell based on a very large new database of letters written by members of Congress to federal agencies. We have spent the past 2 years collecting and coding these data, and I am excited to share the very first results from this project. 
...
% I am going to introduce our data and show that, in fact, the same members who do more policy work also do more constituent service and that both seem to be connected to institutional power. 
...
% [SLIDE} So what do we know about why legislators lobby the bureaucracy? 
...
\item Constituents and institutional position, not ideology, drive policy oversight (Lowande, 2018) \pause
% Lowande, also focusing on policy finds that partisan disagreement the executive branch does not drive oversight.
\item Descriptive $\rightarrow$ substantive (Lowande, Ritchie, Lauterbach, 2018) \pause
...
% To study who does constituent service and when they do it, we assemble a new dataset of requests--letters, emails, phone calls that members of Congress directly to parts of the federal bureaucracy.
...
\begin{figure}
\centering
\caption{Large Variation in Who Contacts Agencies}
