...
% We started with a common intuition that Members of Congress have limited time and attention to divide among, for example, constituency work and policy work. We have come to question the value of this intuition for explaining legislator behavior. 
...
% Not only are legislators who do more constituency service more likely to achieve power in Washington, once they achieve power, they use it to advocate both policy agendas AND individual constituents.
...
% To study who does constituency service and when they do it, we assemble a new dataset of requests--letters, emails, phone calls that members of Congress directly to parts of the federal bureaucracy.
...
% A Dif-in-Dif design supports the conclusion that legislators use institutional power to do more constituency service
\begin{frame}
...
% To what extent are constituents drawn to more powerful elected officials. Is this driven by constituency demand 
