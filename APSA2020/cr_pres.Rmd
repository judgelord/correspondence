...
My colleague at Wisconsin, Rochelle Snyder really led the writing and coding the data for this paper, but she, unfortunately, was scheduled to be teaching at this moment until an email from our chancelor canceled classes for the rest of the week due to covid. So, she might be able to join afterall. I'll go ahead and present the paper and she can fill in any gaps.  

This paper is a new piece from a much larger project we have been working on for over four years, but this specific exploration of how different types of individual constituents are served more than others is Rochelle's brainchild.
...
### If members are more likely to help some constituents (those they represent descriptively, core constituencies, valorized groups), representation may be biased (not proportionate to constituents in a district)
