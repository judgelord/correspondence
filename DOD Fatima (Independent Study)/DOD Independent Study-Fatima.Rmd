---
title: "The Department of Defense and its unique Constituent-Legislator Relationship" 
subtitle: A Study of correspondence in the Department of Defense"
author: "Fatima Ali"
#header-includes:
...
d <- all_contacts %>% filter(str_detect(agency, "DOD")) %>% filter(year <2018, year >2006) #%>% filter(!(last_name == "GRASSLEY"& party == "(R)")) 
...
Altogether we have 7635 letters received by the Department of Defense that are marked as “congressional” from 2007-2017. All of these letters are from Members of the U.S. Congress. 
...
In the future, I hope to continue my exploration with this topic by
# References 
