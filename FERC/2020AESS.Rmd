...
Unequal spending among energy companies
...
```{r, , out.width = "550px"}
knitr::include_graphics("figs/FERC_mooney.png")
```

![](figs/FERC_mooney.png)
...
```{r, out.width = "550px"}
knitr::include_graphics("figs/FERC_thornberry.png")
```

![](figs/FERC_thornberry.png)
...
```{r, out.width = "550px"}
knitr::include_graphics("figs/FERC_collins.png")
```

![](figs/FERC_collins.png)
...
```{r, out.width = "550px"}
knitr::include_graphics("figs/FERC_graham.png")
```

![](figs/FERC_graham.png)
...
```{r, out.width = "550px"}
knitr::include_graphics("figs/schumer-cosigned-letter-tweet.png")
```
...
- PAC money is correlated with pro-business advocacy, but not constituent advocacy, suggesting that pro-business letters are not just about district interests

- Correlations are small, but likely indicate other (unobserved) types of advocacy
...
-   FERC receives an unusually high rate of advocacy on behalf of businesses

-    **Republicans** and those who receive **money from energy companies** write more letters on behalf of energy
