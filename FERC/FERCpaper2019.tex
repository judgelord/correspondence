...
While the preceding figure shows the name and state of high-letter writing outlier Senators, it is difficult to identify the amount of letters coming from each state in the figure.  Figure \ref{f:statepoptotal} shows the number of letters to FERC from Senators by state.   
