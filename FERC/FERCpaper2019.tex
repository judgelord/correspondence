...
\includegraphics[width=\textwidth]{../gh-pages/Figs/population-1.png}
\end{subfigure}
\begin{subfigure}{\columnwidth}
\caption{Letters to FERC}
\includegraphics[width = \textwidth]{population-1.png}
\end{subfigure}
\end{figure}
\clearpage
...
\includegraphics[width = \textwidth]{sentate_percapita_map-1.png}
\end{figure}
