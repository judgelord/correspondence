...
In this paper we use letters legislators write to a bureaucratic agency (the Federal Energy Regulatory Commission) to study congressional attempts to influence bureaucratic decisions. In exploring this question we are strongly influenced by \citet{Arnold1979}'s theory of bureaucrats and legislators who \emph{anticipate} how others will react to their actions. Drawing on eighteen years worth of letters from legislators to the commission, we find that these letters are filled with specific references to companies that legislators seek to assist.  We explore which legislators seek to influence the agency, on whose behalf they seek influence, and what outcome they are attempting to influence.  Finally, we match these letters with campaign finance records to see whether Members' efforts are correlated with the campaign contributions they receive from the energy industry. \todo{Finish abstract to include sentence summarizing paper results.}
