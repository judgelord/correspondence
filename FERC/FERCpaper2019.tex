...
While the projects we have outlined here comprise an ambitious research agenda, we believe they represent a collection of concrete steps that will help advance our knowledge in this area.  Moreoever, we believe that taken together we can use them to build on the foundational insights of \citet{Arnold1979} to better understand the strategic anticipation and signalling that takes place between legislators and bureaucrats. 
