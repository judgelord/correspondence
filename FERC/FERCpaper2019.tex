...
Instead, research by \citet{Hall1996} and subsequent work argues that we have to look at lower levels of Congressional action to detect the influence of corporations.  Building on this logic, subsidy theory of lawmaking suggests that donors will subsidize legislators to take actions that advance legislators explicit goals.   
...
For example, because many natual gas pipelines cross state lines, FERC largely controls pipeline market entry. Similarly, because electricity grids are regional, conflicts between electric-generating companies and state regulators or regional transmission organizations are often appealed to FERC.  
