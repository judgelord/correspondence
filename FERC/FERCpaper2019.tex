...
In this paper, we explore whether campaign contributions drive congressional letter-marking activity in the context of the Federal Energy Regulatory Commission.  Drawing on eighteen years worth of letters from legislators to the commission, we find that these letters are filled with specific references to companies that legislators seek to assist.  We match these letters with campaign finance records to see whether Members' efforts are primarily concerned with their donors or their constituents.  
\end{abstract}
