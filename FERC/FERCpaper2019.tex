...
\includegraphics[width = \textwidth]{models-1}
\caption{\textbf{Figure \ref{f:model1}: }}
\end{figure}
...
\includegraphics[width = \textwidth]{models-2}
\end{figure}
 
\begin{figure}[ht!]
\centering
\caption{}\label{f:model3}
\includegraphics[width = \textwidth]{models-3}
\end{figure}

\begin{figure}[ht!]
\centering
\caption{}\label{f:model4}
\includegraphics[width = \textwidth]{models-4}
\end{figure}
