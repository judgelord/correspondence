...
In dis-aggregating letter-writing activity by party and majority status in Figure \ref{f:party}, we observe that the parties behave differently from each other, and they behave differently themselves when they're in the majority versus when they're in the minority.  When Republicans control the majority they write approximately 65\% of their letters to FERC advocating on behalf of named businesses.  By contrast to when the Republicans are in the majority, when the Republicans are in the minority those ratios flip, and they write nearly 65\% of their letters on behalf of constituents.  
