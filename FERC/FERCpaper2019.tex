...
In contrast to the overall patterns we observe in letter-writing to all agencies, we find very different patterns of activity in letter-writing to the Federal Energy Regulatory Commission. In the aggregate data, letter-writing on behalf of corporate constituents is the least common form of letter-writing activity, that isn't true of letters to the FERC in which almost 30\% of the letters are on behalf of corporate interests. 
