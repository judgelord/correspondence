...
Connecting these contributions to letters written by members of Congress on behalf of the company is more challenging.  They also own the Transcontinental Pipeline Company, the Transcontinental Gas Company, and the Transco Pipeline Company.  In addition, they're the company behind a large number of projects such as the Atlantic Sunrise Project, and the Northeast Supply Enhancement (NESE) Pipeline, among many others.  

Drawing on news reports and company filings with the Securities Exchange Commmissions we have tried to link parent companies, subsidiary companies, and company projects so that we can then link letters to campaign contributions.  While we will present some preliminary results here based on these linkages, we do not yet believe we have comprehensive coverage of these relationships.  
