...
In our research across federal agencies, we typically see senators from larger states doing more constituency service than senators from smaller states. Figure \ref{f:statepop} below shows annual Senate letter-writing by state population.  The figure includes a lowess smoothing trend line and 95\% confidence intervals.  The top panel Senate letter-writing to all agencies in which we observe this positive relationship between state population and Senate letter-writing to all agencies. The bottom panel shows the relationship between state population and only Senate letter-writing to FERC.\footnote{Readers should be careful in noting the differences in y-axis scales between the two panels of this figure.}  The figure includes a lowess smoothing trend line and 95\% confidence intervals. The comparison across these two panels shows a much weaker relationship between state population and letter-writing to FERC than we observed in the data as a whole.  
