...
For example, a legislator who receives \$200,000 from the energy sector is twice as likely to write advocating on behalf of an energy company but no more likely to write on behalf of their constituents or in opposition to an energy project. 
...
Building on \citet{Arnold1979}'s insights into how bureaucrats and legislators \emph{anticipate} how others will react to their actions, we explored a new form of signaling and learning by examining congressional advocacy letters to the Federal Energy Regulatory Commission.  We see evidence consistent with the idea that energy industry campaign contributions lead to more overall letters to FERC, and specifically, more pro-business letters to FERC.  

We believe this chapter represents a starting point for what we can learn about legislator motivations and the impact of money on congressional and bureaucratic relations.  In future work, we hope to expand our analysis to other agencies, as well as other forms of interest group activity (both in the form of other types of campaign contributions such as super PACs and independent expenditures, as well as lobbying efforts, revolving door considerations, etc.).  We also hope to look at the impact of the legislator's letters on the actions taken by the agency---in particular, we hope to focus on the speed of the review by FERC as an outcome, as this is often what companies seek in these requests. 
