...
Thus letters from legislators to bureaucrats may be a promising potential avenue for those seeking to quietly influence government policy in a given area in that the letters are unlikely to receive public scrutiny and often involve relatively obscure federal agencies that aren't well known or understood by the public. Together these factors substantially reduce the ``traceability'' or the ability of a citizen to connect a policy outcome back to an individual legislator's actions \citep{arnold1990lca}. As Frances Lee examines in an earlier chapter in this volume, legislators in today's Congress continue to use procedural tactics described by Arnold (1990) to reduce the traceability of bills and make it more difficult for citizens to hold legislators accountable. 
