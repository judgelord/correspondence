...
Figure \ref{f:lettersmoney1} below shows the average amount a member received in each election cycle from all energy sector PAC contributions combined. The figure reveals that the average legislator receives considerable support for their campaigns from energy-sector PACs.  To put these numbers in perspective, in 2016, the average winning House race cost \$1.5 million, and the average winning Senate race cost \$12 million. The over \$700,000 that the average Republican received from energy PACs is thus a substantial part of the party's fundraising base \citep{CRP2021}. 
