...
```{r pac_amounts, fig.height= 3.55, fig.width=6.5}
library(tidyverse)
...
write_lines(
  stargazer::stargazer(mProTotal, mAntiTotal,             covariate.labels = c("Campaign Contributions (per 100k)", "Republican"),
          dep.var.caption  = "Letters to FERC",
          dep.var.labels   = c("Total", "Pro-business", "Anti-business", "Constituent"),
          float=F),
...
# All models 
write_lines(
  stargazer::stargazer(mAll, mPro, mAnti,mNonConstituent, mProLog, mAntiLog, mProParty, mProTotal, mAntiTotal, mAntiParty, covariate.labels = c("Campaign Contributions (per 100k)", "Republican"),
          dep.var.caption  = "Letters to FERC",
          dep.var.labels   = c("Total", "Pro-business", "Anti-business", "Constituent"),
          float=F),
...
write_lines(
  stargazer::stargazer(mAll_Full, mAll_Fullx, mPro_Full, mAnti_Full,mPro_Fullx, mAnti_Fullx,            covariate.labels = c("Campaign Contributions (100k)", "Republican"),
          dep.var.caption  = "Letters to FERC",
