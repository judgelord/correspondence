...
pac_amounts %>%
  ...
  labs(y = "Total Industry PAC contributions (hundred of thousand)", 
...
pac_amounts %>%
  ...
  geom_col(position = "dodge") + 
  facet_wrap("industry", scales = "free") +
  labs(y = "Average Energy-sector PAC contributions per member (hundred of thousand) \n (ommitting energy extraction companies)", 
       x = "FEC Electoral Cycle")
...
save(letters_money, file = "data/letters_money.Rdata")
```
