...
Problem company names that need to be fixed (e.g. to remove special characters or spell out abbreviated name)
```{r problem-names}
# Problem Names
...
dcorps %>% group_by(company_short) %>% tally() %>% arrange(-nchar(company_short)) 
```
