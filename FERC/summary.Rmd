...
d <- all_contacts %>% filter(agency=="DOE_FERC")
...
FERC_letters %<>% 
  select(ID, text_clean, Place_State, Place_District,Place_District, ProBusiness, AntiBusiness, year) %>% distinct()
