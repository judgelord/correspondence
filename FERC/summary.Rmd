...
Of the companies registered to lobby FERC, several appear in the letter texts. Here `company_short` is a shortened version a name that refrences several affiliated companies, each of which are registered separatly. *TO DO: extract company contact persons and information from the FERC website.*  
```{r}
