...
letters_money %<>% left_join(d %>% 
                               dplyr::select(icpsryear, nominate.dim1, chair_since_2007, oversight_committee) %>%
...
mAll_Full <- glm(All_Letters ~ PAC_contributions + party + chair + oversight_committee, data = All_Letters_money %>% filter(!party %in% c("NA","(I)", "Independent"))%>% mutate(PAC_contributions = PAC_contributions/1000000), family = "poisson" )  
...
mAll_Fullx <- glm(ProBusiness_Letters ~ PAC_contributions*party + chair + oversight_committee, data = All_Letters_money %>% filter(!party %in% c("NA","(I)", "Independent"))%>% mutate(PAC_contributions = PAC_contributions/1000000), family = "poisson" )  
...
mPro_Full <- glm(ProBusiness_Letters ~ PAC_contributions + party + chair + oversight_committee, data = letters_money %>% filter(!party %in% c("NA","(I)", "Independent"))%>% mutate(PAC_contributions = PAC_contributions/1000000), family = "poisson" )  
...
# Full model with interaction:
mPro_Fullx <- glm(ProBusiness_Letters ~ PAC_contributions*party + chair + oversight_committee, data = letters_money %>% filter(!party %in% c("NA","(I)", "Independent"))%>% mutate(PAC_contributions = PAC_contributions/1000000), family = "poisson" )  
...
mAnti_Full <- glm(AntiBusiness_Letters ~ PAC_contributions + party + chair + oversight_committee, data = Antiletters_money %>% filter(!party %in% c("NA","(I)", "Independent"))%>% mutate(PAC_contributions = PAC_contributions/1000000), family = "poisson" )  
...
# full model with interaction 
mAnti_Fullx <- glm(AntiBusiness_Letters ~ PAC_contributions*party + chair + oversight_committee, data = Antiletters_money %>% filter(!party %in% c("NA","(I)", "Independent"))%>% mutate(PAC_contributions = PAC_contributions/1000000), family = "poisson" )  
tidy(mAnti_Fullx)
mplot(mAnti_Fullx)+
  labs(x="", y="Additional letters per congress")
...
write_lines(
  stargazer::stargazer(mPro_Full, mAnti_Full,mPro_Fullx, mAnti_Fullx, float=F),
