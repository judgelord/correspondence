...
```{r}
d %<>% mutate(ProBusiness = str_replace(ProBusiness,"RTO", "Regional Transmission Organization"))%>%
  mutate(AntiBusiness = str_replace(AntiBusiness,"RTO", "Regional Transmission Organization"))
