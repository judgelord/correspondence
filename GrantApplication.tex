...
Given the importance of these classic empirical questions about constituency service we employ a new data set to assess constituency service and its consequences.  In this project we employ the most comprehensive dataset of constituent service requests to date.  Using a large set of Freedom of Information Act (FOIA) requests we have been able to assemble a large data set of nearly every instance of when legislators contact government agencies on behalf of their constituents.  Other scholars working with similar, though less extensive data, have shown that the data on congressional correspondence has yielded important findings regarding the policy strategies of cross-pressured legislators \citep{Ritchie2017}, distributive politics \citep{MillsKalafHuges2015}, descriptive representation \citep{LowandeRitchieLauterbach2018}, and the role of ideology in congressional oversight \citep{Lowande2018JOP}.  We build on this important work in this project to tackle long-standing questions about who provides constituency service, why they provide that service, and how who receives constituency service can perpetuate the role of money in politics and bias the policy creation process towards moneyed interests.  


Our first contribution is a new data set of Congressional correspondence obtained through over 200 Freedom Of Information Act (FOIA) requests.  This comprehensive data set enables us to make inferences about how legislators generally allocate their time, while more prior more narrow data sets have forced scholars to restrict attention to the legislator-agency dyad.  In this proposal we provide a summary of the data that we have already collected and show that even the descriptive facts in the data provide insights into how legislators allocate their time.  After collecting the data, we plan to host make available our comprehensive data set, enabling other scholars to learn from the extensive data that we have collected.  In order to allay concerns about the comprehensiveness of our data, we provide several validations of the validity of the data here. 

With this new data set, we are able to understand representative's behavior around constituent service requests.  In this grant proposal we use our massive initial collection of requests to establish some important descriptive facts. Some members use this tactic more than others, even within strata of institutional power, experience, staffing resources, and national prestige. Furthermore, those who use this tactic use it broadly across issue areas and parts of the government.  Members of Congress who write often to one agency are more likely to write regularly to other agencies as well.  In general, the legislators who engage the bureaucracy do so broadly, across many agencies and advocate both for general policy and for individual constituents.  Using this data, we plan to develop a basic measurement model to more systematically describe the strategies that legislators deploy when contacting federal agencies. 

The data set enables us to answer descriptive questions about who contacts federal agencies and where those contacts are allocated.  It also gives us leverage on a variety of causal questions about how institutional position and rules affect the rate of contact of federal agencies and to characterize the ability of moneyed interests to receive extra attention.  We show that as legislators gain more institutional prestige---becoming a committee chair, gaining a set on a prestige committee, or moving into party leadership---they actually contact \emph{more} federal agencies.  This result holds even in a difference-in-differences research design, where we show that legislators selected for promotions do tend to contact more than other legislators before the promotion.  

Using this basic research design, we are able to better understand how shifts in institutional rules and how government decisions get made. In particular, we can use our design to understand the consequences of contacting federal agencies on decisions to allocate money.  To do this, we can 
...
\includegraphics[width = 4in]{ideology_density-2}
\includegraphics[width = 4in]{ideology_density-3}
\end{figure}
