...
data <- extractMemberName(data, members, 'FROM')
  ...
  data %<>%
    ...
    mutate(ERROR = ifelse(str_detect(FROM, "Chafee, Lincoln D") & congress %in% c(113), "No longer in congress", ERROR)) %>%
