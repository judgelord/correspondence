...
clean <- function(file.name) {
  ...
  data %<>%
    ...
    mutate(FROM = str_replace(FROM, "BUTTERFIELD, G|BUTTERFIELD, G\\.K|BUTTERFIELD, G\\. K|Butterfield, G\\. K\\.|BUTTERFIELD, G\\.K\\.|Butterfield, GK", "George BUTTERFIELD")) %>%
