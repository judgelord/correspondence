...
data %<>% 
 ...
 #Sample Test code
  ...
  data %<>%
    ...
    mutate(ERROR = ifelse(str_detect(FROM, "KEVIN FROMER|AMIEE SNYDER|ELEANOR HOLMES-NORTON|PATRICIA LARKE|MADELEINE BORDALLO|MATT HUTCHINSON"), "Not Member", ERROR))
