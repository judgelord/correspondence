---
title: "Tidy text analysis example: web scraping tables and files in R with `rvest`"
...
> **Note:** The R Markdown file that made this document is [here](https://github.com/judgelord/correspondence/blob/master/functions/DOE_FERC-scraper.Rmd), and you can download an example .htm file [here](https://raw.githubusercontent.com/judgelord/correspondence/master/FERC/html/1.htm) (put it in a folder "FERC/html" or change the file path arguments below to match the location of your .htm files).


# Load saved html files 

In this case, the HTML is [search results from the FERC elibrary](https://elibrary.ferc.gov/idmws/search/fercgensearch.asp) saved in a folder named "FERC/html". 
```{r}
