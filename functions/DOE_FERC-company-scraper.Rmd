...
url <- c(url,
         ...
         "https://www.ferc.gov/docs-filing/corp-off/gas/gas-X-Y-Z.asp?csrt=16593465655017166281")
...
FERC_letters$company_short <- str_extract_all(FERC_letters$summary, ferc_short) %>% map_chr(str_unique) %>% str_remove_all("^; |; ; |; $")

# Number of summaries where a company from the FERC website was found:
