...
## Load congressional letters data 
gs_auth() # log in to google docs
FERC_letters <- gs_title("DOE_FERC Extended") %>% gs_read()

## Split availability status from summary
FERC_letters %<>% separate(SUBJECT, into = c("summary", "availability"), sep = "Availability: ")

## Combine letter summary and letter text
FERC_letters %<>% 
  mutate(text = str_c(text, sep = "; ")) %>%
  mutate(text = str_c(SUBJECT, text, sep = ". Letter Text: ")) 
