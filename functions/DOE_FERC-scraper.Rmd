...
The aim is to make a table with both the text of letters and information from the FERC website, such as the date the letter was received. 

Here are the major steps
1. Scrape the table of letters received
...
d %<>% separate(SUBJECT, into = c("summary", "availability"), sep = "Availability: ") 

## name 
FERC_letters <- d

## save
# save(FERC_letters, file = here("data", "FERC_files.Rdata"))
