intercoder.agreement <- function(data){
  ...
  # upload file of cases to recoded
  recode <- "recode.csv"
  ...
  return(paste("Intercoder agreement:", intercoder[2,2], "of", intercoder[1,2], "=", intercoder[2,2]/intercoder[1,2], "and 
 intercoder agreement for CERTIAN==1:", intercoder1[2,2], "of", intercoder1[1,2], "=", intercoder1[2,2]/intercoder1[1,2]
  ))
}
